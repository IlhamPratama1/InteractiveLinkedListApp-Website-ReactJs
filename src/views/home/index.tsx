            ...
            <div className="h-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4">
                <div className="h-full">
                    ...
                    <div className="h-full flex justify-center items-center">
                        <img className="scale-90" alt="home" src="/static/illustration/home-img.png" />
                    </div>
                </div>
                <div className="h-full flex items-center p-8 sm:p-12 md:p-20">
                    <div className="space-y-8 lg:space-y-12 font-roboto">
                        ...
                        <div className="flex space-x-4 lg:space-x-8">
                            <Link to={'/login'} className="rounded-md px-10 py-3 bg-cyan-light text-blue-dark font-bold text-sm md:text-md lg:text-lg">Login</Link>
                            <Link to={'/register'} className="rounded-md px-10 py-3 bg-blue-dark text-cyan-light font-bold text-sm md:text-md lg:text-lg">Try Now</Link>
                        </div>
                    </div>
                </div>
            </div>
